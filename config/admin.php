...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/uploads/images/Dingtalk_20201216132517.jpg" width="35"> &nbsp;ZSY-Admin',
   ...
   */
    ...
    'grid' => [
        ...
        */
        ...
        //'grid_action_class' => Dcat\Admin\Grid\Displayers\DropdownActions::class,
         'grid_action_class' =>App\Admin\Grid\Displayers\RowActions::class,
    ],
    ...
    */
    'layout' => [
        ...
        // light,bg-primary, bg-info, bg-warning, bg-success, bg-danger, bg-dark
        'navbar_color' => 'light',
    ],
